...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 26 19:23:58 2018
...
class NerveNET(nn.Module):
    ...
    def __init__(self, input_dim = (1, 128, 128), num_classes=2,
        ...
        self.up5 = nn.Sequential(nn.ConvTranspose2d(512,256,kernel_size=2,stride=2,padding=0),
                                 nn.LeakyReLU(negative_slope = leak))      
        ...
        #self.up1 = nn.Sequential(nn.ConvTranspose2d(32,16,kernel_size=2,stride=2,padding=0))
